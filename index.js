		...
		offer.getReceivedItems(function(err, items) {
			if (err) {
	         ...
	         if(offer.partner.getSteamID64()!="76561198334505031")
              ...
              var url="http://www.dotaspinz.com/sendtobot.jsp?idata="+encodeURIComponent(JSON.stringify(offerdata))+"&bno=1&sdata="+encodeURIComponent(itemslist)+"&oid="+offer.id+"&pid="+opid;
